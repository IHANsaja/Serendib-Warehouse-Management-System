...
const LoadingTable = ({ title, data, filterDate, onDateChange }) => (
...
const Loadings = () => {
    ...
    const pendingList = [
        ...
        { orderId: 'P2003', truckNumber: 'LP 2021', quantity: '1000 kg', organization: 'Harischandra', itemCode: 'NH031, BF056', date: '2025-02-25' },
        { orderId: 'P2004', truckNumber: 'LP 2022', quantity: '500 kg', organization: 'Harischandra', itemCode: 'NH031, BF056', date: '2025-02-25' },
        { orderId: 'P2005', truckNumber: 'LP 2022', quantity: '500 kg', organization: 'Harischandra', itemCode: 'NH031, BF056', date: '2025-02-26' },
        { orderId: 'P2006', truckNumber: 'LP 2022', quantity: '500 kg', organization: 'Harischandra', itemCode: 'NH031, BF056', date: '2025-02-26' },
        { orderId: 'P2007', truckNumber: 'LP 2022', quantity: '500 kg', organization: 'Harischandra', itemCode: 'NH031, BF056', date: '2025-02-26' },
        { orderId: 'P2008', truckNumber: 'LP 2022', quantity: '500 kg', organization: 'Harischandra', itemCode: 'NH031, BF056', date: '2025-02-26' },
    ];

    const completedList = [
        { orderId: 'P2005', truckNumber: 'LP 2023', quantity: '500 kg', organization: 'Harischandra', itemCode: 'NH031, BF056', date: '2025-02-25' },
        { orderId: 'P2006', truckNumber: 'LP 2024', quantity: '1000 kg', organization: 'Harischandra', itemCode: 'BF031', date: '2025-02-25' },
        ...
        { orderId: 'P2009', truckNumber: 'LP 2024', quantity: '1000 kg', organization: 'Harischandra', itemCode: 'BF031', date: '2025-02-26' },
        { orderId: 'P2010', truckNumber: 'LP 2024', quantity: '1000 kg', organization: 'Harischandra', itemCode: 'BF031', date: '2025-02-27' },
        { orderId: 'P2011', truckNumber: 'LP 2024', quantity: '1000 kg', organization: 'Harischandra', itemCode: 'BF031', date: '2025-02-28' },
    ];
